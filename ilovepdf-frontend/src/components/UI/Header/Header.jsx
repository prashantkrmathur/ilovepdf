      ...
      <nav className='poppins-regular'>
        ...
        <div className="pdf-tools-container">
          <ul className="main-menu">
            <li><span>Merge PDF</span></li>
            <li><span>Split PDF</span></li>
            <li><span>Compress PDF</span></li>
            ...
            >
             <div className="oneline"> <span>Convert PDF</span> <FaChevronDown className="dropdown-icon" /></div>
              {showConvertMenu && (
            ...
            >
              <div className='oneline'> <span>All PDF Tools</span> <FaChevronDown className="dropdown-icon" /></div>
